...
Снова откройте Инcтрументы. Там где выбор платы, должно появиться подменю с “ESP8266 Boards”. 
...
Задайте название бота, например “Artems temp and hum bot”, оно может быть не уникальным, с пробелами и т д.

Задайте имя бота, например (artems_temp_hum_bot). Оно должно быть уникальным, на английском, без пробелов, и заканчиваться на \_bot или Bot.

Телеграм выдаст вам токен - надо его скопировать, эту строку, например, на флешку и перенести на комп, иначе будет тяжело вводить символы один за другим (обращайте внимание на похожие, например, английские l,I, и цифру 1. 
